...
class Metaclass_OddEvenCheck_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('first_rpm_project')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_OddEvenCheck(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'first_rpm_project.srv.OddEvenCheck')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from first_rpm_project.srv import _odd_even_check
...
class OddEvenCheck(metaclass=Metaclass_OddEvenCheck):
    from first_rpm_project.srv._odd_even_check import OddEvenCheck_Request as Request
    from first_rpm_project.srv._odd_even_check import OddEvenCheck_Response as Response
