...
#include "first_rpm_project/srv/detail/odd_even_check__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_first_rpm_project
cdr_serialize(
  const first_rpm_project::srv::OddEvenCheck_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  first_rpm_project::srv::OddEvenCheck_Request & ros_message)
{
  // Member: number
  cdr >> ros_message.number;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = first_rpm_project::srv::OddEvenCheck_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const first_rpm_project::srv::OddEvenCheck_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<first_rpm_project::srv::OddEvenCheck_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_first_rpm_project
const rosidl_message_type_support_t *
get_message_type_support_handle<first_rpm_project::srv::OddEvenCheck_Request>()
{
  return &first_rpm_project::srv::typesupport_fastrtps_cpp::_OddEvenCheck_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, first_rpm_project, srv, OddEvenCheck_Request)() {
  return &first_rpm_project::srv::typesupport_fastrtps_cpp::_OddEvenCheck_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_first_rpm_project
cdr_serialize(
  const first_rpm_project::srv::OddEvenCheck_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: decision
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  first_rpm_project::srv::OddEvenCheck_Response & ros_message)
{
  // Member: decision
  cdr >> ros_message.decision;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = first_rpm_project::srv::OddEvenCheck_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const first_rpm_project::srv::OddEvenCheck_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<first_rpm_project::srv::OddEvenCheck_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &first_rpm_project::srv::typesupport_fastrtps_cpp::_OddEvenCheck_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, first_rpm_project, srv, OddEvenCheck_Response)() {
  return &first_rpm_project::srv::typesupport_fastrtps_cpp::_OddEvenCheck_Response__handle;
}
...
{
  return &first_rpm_project::srv::typesupport_fastrtps_cpp::_OddEvenCheck__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, first_rpm_project, srv, OddEvenCheck)() {
  return &first_rpm_project::srv::typesupport_fastrtps_cpp::_OddEvenCheck__handle;
}
