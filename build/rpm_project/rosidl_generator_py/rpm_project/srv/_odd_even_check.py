...
class Metaclass_OddEvenCheck_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('rpm_project')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_OddEvenCheck(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rpm_project.srv import _odd_even_check
...
class OddEvenCheck(metaclass=Metaclass_OddEvenCheck):
    from rpm_project.srv._odd_even_check import OddEvenCheck_Request as Request
    from rpm_project.srv._odd_even_check import OddEvenCheck_Response as Response
