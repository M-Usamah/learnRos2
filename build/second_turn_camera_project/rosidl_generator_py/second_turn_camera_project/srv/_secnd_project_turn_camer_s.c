...
bool second_turn_camera_project__srv__secnd_project_turn_camer__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("second_turn_camera_project.srv._secnd_project_turn_camer.SecndProjectTurnCamer_Request", full_classname_dest, 86) == 0);
  }
  second_turn_camera_project__srv__SecndProjectTurnCamer_Request * ros_message = _ros_message;
  {  // degree_turn
...
{
  /* NOTE(esteve): Call constructor of SecndProjectTurnCamer_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("second_turn_camera_project.srv._secnd_project_turn_camer");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SecndProjectTurnCamer_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool second_turn_camera_project__srv__secnd_project_turn_camer__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("second_turn_camera_project.srv._secnd_project_turn_camer.SecndProjectTurnCamer_Response", full_classname_dest, 87) == 0);
  }
  second_turn_camera_project__srv__SecndProjectTurnCamer_Response * ros_message = _ros_message;
  {  // image
...
{
  /* NOTE(esteve): Call constructor of SecndProjectTurnCamer_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("second_turn_camera_project.srv._secnd_project_turn_camer");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SecndProjectTurnCamer_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
